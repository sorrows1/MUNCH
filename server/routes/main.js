...
let errors = [
  { text: 'First error msg using errors' },
  { text: 'Second error msg using errors' },
  { text: 'Third error msg using errors' },
];
...
router.get('/about', (req, res) => {
  ...
  res.render('about', {
    // Activates views/about.handlebar, passing author as a variable
